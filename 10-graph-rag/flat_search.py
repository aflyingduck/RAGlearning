"""
Flat vector search over chunks -- the baseline every other project in this
curriculum has used. Here it's the control group: this project shows a
question flat chunk retrieval structurally cannot answer, no matter how
it's phrased, because the answer isn't IN any one chunk -- it's the
connection between facts stated in two separate, differently-worded chunks.

Usage:
    python flat_search.py "query" --top-k 5
"""
...
def main():
    ...
    print(f"=== FLAT SEARCH RESULTS for {args.query!r} ===\n")
